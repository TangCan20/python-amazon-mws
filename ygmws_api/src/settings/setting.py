...
class _SETTING(object):
    API_TASK_QUEUE = CONST.SYSTEM_NAME + '_' + CONST.SUBSYSTEM_API + '_task_queue'
    ...
    def __init__(self):
        ...
        self.global_config_list = [
            ...
            ('max_api_task_queue_size', int, 'REDIS')
        ]
    ...
    def load_cfg_from_remote(self):
        try:
            ...
            setattr(self, 'SERVER_URL', server_url)
            setattr(self, 'NODE_IP', real_node_ip)
